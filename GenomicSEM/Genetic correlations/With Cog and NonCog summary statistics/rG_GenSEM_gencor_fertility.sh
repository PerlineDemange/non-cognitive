...
Rscript --no-save --slave Gene_cor_GenSEM_LISA_gencor.R "sumstats_fertility.csv" gencor_fertility "gencor_fertility.Rda"


#Copy output folder back from scratch
cp *.csv $HOME/CogNonCog/Genetic_Correlations/Output_cor/ 