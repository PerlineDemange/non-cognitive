...
Rscript --no-save --slave run_rG_woSNPcov01.R "sumstats_all_20200513.csv" gencor_all_woSNP_cov01 



#Copy output folder back from scratch
cp *.Rda $HOME/CogNonCog/Genetic_Correlations/woSNP/Covariance_CogNonCog/Output_cov01/ 
cp *.csv $HOME/CogNonCog/Genetic_Correlations/woSNP/Covariance_CogNonCog/Output_cov01/ 
