...
cp -r $HOME/CogNonCog/Genetic_Correlations/woSNP/Cogent_UKB/Input/* .
...
Rscript --no-save --slave run_rG_woSNP_CogentUKB.R "sumstats_all_20200513.csv" gencor_all_woSNP_CogentUKB 



#Copy output folder back from scratch
cp *.Rda $HOME/CogNonCog/Genetic_Correlations/woSNP/Cogent_UKB/Output/
cp *.csv $HOME/CogNonCog/Genetic_Correlations/woSNP/Cogent_UKB/Output/