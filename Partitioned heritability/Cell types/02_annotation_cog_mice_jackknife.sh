...
--h2 /home/pdemange/CogNonCog/Annotations/Sumstats/Cog_23andMe.sumstats.gz \
...
--out /home/pdemange/CogNonCog/Annotations/LDSC/shoulder10k_nowindow_baselineld2.2_jackknife/Cog/Cog.__ANNOT__ \
--print-coefficients \
--print-delete-vals
